...
const players = [
  {
    ...
    tournaments: 'Рекордное количество побед в супертурнирах: Вейк-ан-Зее (8 раз), Norway Chess (4 раза), турниры Grand Chess Tour, Мемориал Таля, London Chess Classic.', Чемпионат мира по классическим шахматам (8 раз)
